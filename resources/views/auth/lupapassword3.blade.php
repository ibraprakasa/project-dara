...
<body>
    <div class="global-container"><br>
        ...
        <form action="{{ route('lupapassword3.post') }}" method="post">
            ...
            <p style="margin-bottom:20px;text-align:center; font-family:'Poppins',sans-serif;color:#3B4B65;font-weight:bolder;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="password" name="passwordbaru" id="passwordbaru" class="form-control" placeholder="Masukkan Password Baru" required autofocus oninvalid="this.setCustomValidity('Password Baru anda Kosong!')" oninput="this.setCustomValidity('')">
                    </div>
                </div>
                <div class="col">
                </div>
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="form-group">
                        <input type="password" name="passwordkonfirmasi" id="passwordkonfirmasi" class="form-control" placeholder="Konfirmasi Password Baru" required oninvalid="this.setCustomValidity('Konfirmasi Password Baru Anda Kosong!')" oninput="this.setCustomValidity('')">
                    </div>
                </div>
                <div class="col">
