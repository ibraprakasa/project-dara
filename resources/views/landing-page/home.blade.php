      ...
      <div class="w-full md:w-1/2 px-4"> <!-- Bagian teks (setengah lebar pada layar medium dan lebih besar) -->
        <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
          ...
          <ul class="mb-10 flex gap-5 flex-wrap items-center justify-center">
            <li>
              <a href="https://links.tailgrids.com/play-download" target="_blank" class="inline-flex items-center justify-center rounded-md bg-white gap-4 py-[14px] px-7 text-center text-base font-medium text-dark shadow-1  hover:bg-secondary hover:text-white  transition duration-300 ease-in-out">
            ...
            <li>
              <a href="https://github.com/ibraprakasa/project-dara" target="_blank" class="flex items-center gap-4 py-[14px] rounded-md bg-dark px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-secondary hover:text-white">
