            ...
            <div class="modal-header">
              ...
              <span aria-hidden=" true">&times;</span>
                ...
                <form action="{{ route('updatejadwaldonor', ['id' => $row->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="color:black; font-weight:bold">
                        <label for="longitude">Longitude</label>
                        <input class="kolom form-control" type="number" id="longitude" name="editlongitude" value="{{ $row->longitude }}" required>
                    </div>
                    <div class="form-group" style="color:black; font-weight:bold">
                        <label for="latitude">Latitude</label>
                        <input class="kolom form-control" type="number" id="latitude" name="editlatitude" value="{{ $row->latitude }}" required>
                    </div>
